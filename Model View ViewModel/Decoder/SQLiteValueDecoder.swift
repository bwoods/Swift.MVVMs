...
fileprivate var dateFormatter: DateFormatter = { // FIXME: pass all the way down from the Decodable constructor?
...
// MARK: SingleValueDecodingContainer methods
	...
	func decode(_ type: String.Type) throws -> String { return String(cString: sqlite3_column_text(stmt, column)) }
